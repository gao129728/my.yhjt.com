                        ...
                        <script id="list-template" type="text/html">
                            {{# for(var i=0;i<d.length;i++){  }}
                                <tr class="long-td">
                                    ...
                                    <td><div class="updateText" onclick="toggleInput(this,{{d[i].id}},'sortnum','article')">{{d[i].sortnum}}</div></td>
                                    <td><div class="updateText" onclick="toggleInput(this,{{d[i].id}},'title','article')">{{d[i].title}}</div></td>
                                    <td>{{d[i].name}}</td>                                 
                                    ...
                                    <td>
                                        ...
                                        {{# } }}
                                        <a href="javascript:;" onclick="edit_article({{d[i].id}},{{d[i].page}})" class="btn btn-primary btn-xs btn-outline">
...
<script type="text/javascript">
    ...
    function add_article(){
        ...
        location.href="<?php echo url('add_article'); ?>?cate_id="+cate_id;
    }
    ...
    function add_annex(file_path,id,page){
        ...
        layer.open({
            ...
            shade: 0.3,
            area: ['768px', '410px'],
            content: '<?php echo url("article/upload_file"); ?>?file_path='+file_path+'&field=annex&cate_id='+cate_id+'&id='+id+'&page='+page //iframe的url
        });
    }
