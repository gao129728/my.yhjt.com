<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"E:\php_project\my.yhjt.com\public/../application/admin/view/message/index.html";i:1636014324;s:78:"E:\php_project\my.yhjt.com\public/../application/admin/view/public/header.html";i:1544408304;s:78:"E:\php_project\my.yhjt.com\public/../application/admin/view/public/footer.html";i:1527911724;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <script id="list-template" type="text/html">
                            ...
                            {{# if(d[i].isMessage === 1){ }}
                                <tr class="long-td">
                                    ...
                                    <td class="edit-td">{{d[i].sortnum}}</td>
                                    <td>{{d[i].name}}</td>
                                    <td>{{d[i].phone}}</td>
                                    <td>{{d[i].email}}</td>
                                    <td>{{d[i].content}}</td>
                                    ...
                                    <td><input type="checkbox" name="status" data-id="{{d[i].id}}" data-table="message" class="lcs_check lcs_switch lcs_sm" {{d[i].status==1?'checked':''}}/></td>
                                    <td>
...
<script type="text/javascript">
    ...
    function batch_delete(){
        ...
        layer.confirm('确认删除所选记录吗?', {icon: 3, title:'提示'}, function(index){
            ids = ids.substring(1);
            $.getJSON('<?php echo url("message/all_del_message"); ?>', {'ids' : ids}, function(res){
                if(res.code == 1){
...
function view_message(id, page){
    var name=$('#name').val();
    var phone = $('#phone').val();
    location.href = '<?php echo url("message/view_message"); ?>?id='+id+'&name='+name+'&phone='+phone+'&cur_page='+page;
}
...
function refresh_page(page){
    var name=$('#name').val();
    var phone = $('#phone').val();
    location.href = '<?php echo url("message/index"); ?>?name='+name+'&phone='+phone+'&cur_page='+page;
}
