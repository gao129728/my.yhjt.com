<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"E:\php_project\my.yhjt.com\public/../application/admin/view/user/index.html";i:1557368190;s:78:"E:\php_project\my.yhjt.com\public/../application/admin/view/public/header.html";i:1544408304;s:78:"E:\php_project\my.yhjt.com\public/../application/admin/view/public/footer.html";i:1527911724;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="row">
                ...
                <div  class="col-sm-2 ibox-tit" style="width: 100px">
                    <div class="input-group" >  
                        <a href="<?php echo url('user_add'); ?>"><button class="btn btn-outline btn-primary" type="button">添加用户</button></a>
                    </div>
                </div>                                            
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <script id="list-template" type="text/html">
                            ...
                            <tr class="long-td">
                                ...
                                <td>{{d[i].real_name}}</td>
                                <td><input type="checkbox" name="status" data-id="{{d[i].id}}" data-table="admin" class="lcs_check lcs_switch lcs_sm" {{d[i].status==1?'checked':''}}/></td>
                                <td>
