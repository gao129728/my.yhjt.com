                ...
                <div class="ibox-content">
                    <div class="panel-options">
                        <ul class="nav nav-tabs">
                            ...
                            <?php if($cate_info['is_piclist'] == 1): ?><li><a data-toggle="tab" href="#tab-3" aria-expanded="false">其它设置</a></li><?php endif; ?>
                        </ul>
                    </div>
                        ...
                        <div class="tab-content">
                            <div id="tab-1" class="tab-pane active">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-4">
                                        <input type="text" name="<?php echo $vos['value']; ?>" id="<?php echo $vos['value']; ?>" class="form-control p_price" value="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-7">
                                        ...
                                        <textarea name="<?php echo $vos['value']; ?>" style="width:100%" id="myEditors<?php echo $i; ?>"></textarea>
                                    ...
                                    <div class="col-sm-7">
                                         <div class="radio i-checks">
                                            <?php if(is_array($vos['list']) || $vos['list'] instanceof \think\Collection || $vos['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vos['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voss): $mod = ($i % 2 );++$i;if($vos['style'] == 1): ?>
                                                ...
                                                <input type="radio" name='attribute_id[<?php echo $j; ?>]' value="<?php echo $voss['id']; ?>" /><?php echo $voss['name']; ?>&nbsp;&nbsp;

                                            <?php else: ?>
                                                <input type="checkbox" name='attribute_id[<?php echo $j; ?>][]' value="<?php echo $voss['id']; ?>"  /><?php echo $voss['name']; ?>&nbsp;&nbsp;
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-7">
                                        ...
                                        <textarea name="intro" style="width:100%" id="myEditor3"></textarea>
                                        <script type="text/javascript">
