<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"E:\php_project\my.yhjt.com\public/../application/admin/view/role/index.html";i:1527922748;s:78:"E:\php_project\my.yhjt.com\public/../application/admin/view/public/header.html";i:1544408304;s:78:"E:\php_project\my.yhjt.com\public/../application/admin/view/public/footer.html";i:1527911724;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <script id="list-template" type="text/html">
                            {{# for(var i=0;i<d.length;i++){  }}
                                <tr class="long-td">
                                    ...
                                    <td>{{d[i].title}}</td>
                                    {{# if(d[i].id!==1){ }}
                                    <td><input type="checkbox" name="status" data-id="{{d[i].id}}" data-table="auth_group" class="lcs_check lcs_switch lcs_sm" {{d[i].status==1?'checked':''}}/></td>
