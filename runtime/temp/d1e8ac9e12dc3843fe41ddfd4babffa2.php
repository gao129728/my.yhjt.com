<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"E:\php_project\my.yhjt.com\public/../application/admin/view/message/view_message.html";i:1531301772;s:78:"E:\php_project\my.yhjt.com\public/../application/admin/view/public/header.html";i:1544408304;s:78:"E:\php_project\my.yhjt.com\public/../application/admin/view/public/footer.html";i:1527911724;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <form class="form-horizontal m-t view-form" name="edit" id="edit" method="post" action="view_message">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="sortnum" type="text" class="form-control input_wd1" name="sortnum" placeholder="输入序号" value="<?php echo $message['sortnum']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-7">
                                <textarea name="reply" style="width:100%" id="myEditor"><?php echo $message['reply']; ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class=" col-sm-1">
                                <div class="radio i-checks">
                                    <input type="radio" name='status' value="1" <?php if($message['status'] == 1): ?>checked<?php endif; ?>/>显示&nbsp;&nbsp;
                                    <input type="radio" name='status' value="2" <?php if($message['status'] == 2): ?>checked<?php endif; ?>/>不显示
                                </div>
                            </div>
