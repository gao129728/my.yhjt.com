...
class AttributeModel extends Model
{
    ...
    {
        $table = config('database.prefix').'classification';
        return $this->alias('a')->field('a.*,b.name as catename')->join($table.' b', 'a.class_id = b.id')->where($map)->page($Nowpage, $limits)->order('a.class_id asc,a.sortnum asc,a.id asc ')->select();
    }
