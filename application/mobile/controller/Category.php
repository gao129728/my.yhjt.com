...
//       ||$cate_arr[1]['id'] == 55
        ...
        $subCur_name = $cate_arr[1]['name'];  //二级id
        $this->assign('subCur_name',$subCur_name);
...
//        dump($subCur);
        ...
        $third_name = $cateCur['name'];
        $this->assign('third_name',$third_name);
...
// dump( $cate_arr[0]);
    ...
    public function detail()
    {
        ...
        $subCur = $cate_arr[1]['id'];  //二级id
        $this->assign('subCur',$subCur);

        $subCur_name = $cate_arr[1]['name'];  //二级name
        $this->assign('subCur_name',$subCur_name);
//        dump($cateCur);
