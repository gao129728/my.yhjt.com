...
//$mail->addAttachment("bug0.jpg");// 添加附件
        ...
        $mail->Body = "尊敬的宇寰会员,您的密码已经修改为：".$pass.",请点击下方链接确认密码http://yhjt.cfsite4.ahcfkj.com/home/member/getMessage?email=".$encrypt_email."&pass=".$encrypt_pass.",若不是本人操作，请忽略！";// 邮件正文
